...
import { facultyUpdate, facultyUpdatePassword, facultyLogout } from '../../redux/actions/facultyAction';
...
const FacultySettings = () => {
  ...
  const [mobile, setMobile] = useState(faculty.facultyMobileNumber || '');
  const avatarUrl = faculty?.avatar?.url || '';
  ...
  const handleProfileSubmit = async (e) => {
    ...
    form.append('facultyMobileNumber', mobile);
    form.append('email', email);
    form.append('avatar', avatar);
    form.append('registrationNumber', faculty.registrationNumber);
    dispatch(facultyUpdate(form));
          ...
          <Grid item xs={12} md={4}>
            <Card sx={{ height: '100%', minHeight: { md: 360, xs: 'auto' } }}>
              <CardContent sx={{ textAlign: 'center', p: 3 }}>
                <Avatar
                  sx={{ width: 80, height: 80, mx: 'auto', mb: 2 }}src={avatarPreview}>
                ...
                <List dense>
                  <ListItem sx={{ px: 0 }}>
                    ...
                    <ListItemText primary="Email" secondary={faculty.email} />
                  </ListItem>
                  <ListItem sx={{ px: 0 }}>
                    <ListItemIcon>
                      <PhoneIcon color="primary" />
                    </ListItemIcon>
                    <ListItemText primary="Contact" secondary={faculty.facultyMobileNumber} />
                  </ListItem>
                </List>
              </CardContent>
            </Card>
                      ...
                      <Grid container spacing={2}>
                        <Grid item xs={12}>
                          <TextField
                            ...
                            InputProps={{ startAdornment: <InputAdornment position="start"><LockIcon /></InputAdornment>, endAdornment: (
