...
const AdminNotifications = () => {
  const [notifications, setNotifications] = useState([
    { id: 1, title: 'System Health', body: 'MongoDB connected successfully.', read: false },
    { id: 2, title: 'New Faculty Registered', body: 'A new faculty account was created.', read: false },
    { id: 3, title: 'Hostel Report Ready', body: 'Monthly hostel fee report generated.', read: true },
  ]);
