...
import { adminAddApplicant } from '../../redux/actions/adminAction';
...
const AdminAddApplicant = () => {
  ...
  const validateStep = (step) => {
    ...
    switch (step) {
      ...
      case 1:
        ...
        if (!formData.previousQualification || !formData.previousQualification.trim()) newErrors.previousQualification = 'Previous qualification is required';
        if (!formData.previousMarks || !formData.previousMarks.trim()) newErrors.previousMarks = 'Previous marks are required';
        if (!formData.previousSchool || !formData.previousSchool.trim()) newErrors.previousSchool = 'Previous school is required';
        break;
      case 2:
        ...
        if (!formData.motherName || !formData.motherName.trim()) newErrors.motherName = 'Mother name is required';
  ...
  const formHandler = async (e) => {
    ...
    try {
      const res = await dispatch(adminAddApplicant(formData));
      ...
      if (res?.success) {
        ...
        throw new Error(res?.error?.message || 'Failed to add applicant');
      }
    } catch (error) {
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={handleInputChange('previousQualification')}
                error={!!errors.previousQualification}
                helperText={errors.previousQualification}
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={handleInputChange('previousMarks')}
                error={!!errors.previousMarks}
                helperText={errors.previousMarks}
                placeholder="e.g., 85"
              />
            </Grid>
            <Grid item xs={12} md={6}>
          ...
          <Box>
            ...
            <Paper sx={{ p: 3, mb: 3, border: '2px solid', borderColor: 'primary.main' }}>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} md={6}>
                  ...
                  <Typography variant="body1" sx={{ mb: 1 }}>{formData.contactNumber}</Typography>
                </Grid>
                <Grid item xs={12} md={6}>
                ...
                <Grid item xs={12} md={6}>
                  ...
                  <Typography variant="body1" sx={{ mb: 1 }}>{formData.motherName}</Typography>
                </Grid>
                <Grid item xs={12} md={6}>
                  <Typography variant="subtitle2" color="text.secondary">Previous Qualification:</Typography>
                  <Typography variant="body1" sx={{ mb: 1 }}>{formData.previousQualification}</Typography>
                </Grid>
                <Grid item xs={12} md={6}>
                  <Typography variant="subtitle2" color="text.secondary">Previous Marks:</Typography>
                  <Typography variant="body1" sx={{ mb: 1 }}>{formData.previousMarks}%</Typography>
                </Grid>
                <Grid item xs={12}>
            ...
            <Box sx={{ textAlign: 'center', p: 2, bgcolor: 'warning.light', borderRadius: 2 }}>
              <Typography variant="body2" color="warning.contrastText">
                ⚠️ Please verify all information is correct before clicking "Add Applicant"
              </Typography>
            </Box>
          </Box>
        );
  ...
  return (
    <AdminLayout title="Add New Applicant">
      <Box sx={{ 
        p: { xs: 0.5, sm: 1, md: 2 },
        width: '100%',
        maxWidth: '100%',
        ...
        >
          ...
          <Box sx={{ 
            ...
            >
              Fill in the applicant information to add them to the system
            </Typography>
          </Box>
      ...
      {showConfirmDialog && (
        ...
        >
          <Paper sx={{ 
            ...
            >
              Are you sure you want to add this applicant? This action cannot be undone.
            </Typography>
            <Box sx={{ 
              display: 'flex', 
              gap: 2, 
