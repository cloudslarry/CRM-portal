...
const CollegeInfo = () => {
  ...
  if (error) return <ApplicantLayout><Container sx={{ py: 6 }}><Typography color="error">{error}</Typography></Container></ApplicantLayout>;
  if (!info) return <ApplicantLayout><Container sx={{ py: 6 }}><Typography>Loading...</Typography></Container></ApplicantLayout>;

  return (
    <ApplicantLayout title="College Information">
